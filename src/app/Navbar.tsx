...
function Navbar() {
    return (
        <>
            <div className="fixed top-0 left-0 right-0 z-50 grid grid-cols-3 justify-center place-items-center px-2 border mt-2 py-2 mx-2 bg-transparent rounded-3xl shadow backdrop-blur-2xl duration-500">
