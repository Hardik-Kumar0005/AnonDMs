...
function MessageCard( {message, deleteMessage}: Props) {
  ...
  return (
    <div className='relative bg-cyan-200 rounded-2xl border-2 shadow-md md:hover:scale-105 hover:scale-105 hover:z-101 hover:border-4 hover:border-amber-800 active:border-amber-400 transition-transform duration-200 ease-in-out min-h-[120px] max-w-xl w-full flex flex-col justify-between max-h-fit overflow-y-auto'>
